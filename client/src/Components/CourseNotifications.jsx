            ...
            {loading ? (
              ...
              notifications.map((notification) => (
                <div
                  ...
                  className={`p-4 border-b border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer transition-colors ${!notification.isRead ? 'bg-primary/5 dark:bg-primary/10' : ''
                    }`}
                  onClick={async () => {
                      ...
                      <div className="flex items-center justify-between mt-2">
                        <div className="flex items-center gap-2">
                          ...
                          {notification.actionText && (
                            <span className="text-xs bg-primary/10 dark:bg-primary/20 text-primary dark:text-primary-light px-2 py-1 rounded">
                              {notification.actionText}
                            </span>
                          )}
                        </div>
