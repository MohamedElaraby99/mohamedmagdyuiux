...
const faqData = [
  ...
  },
  {
    ...
    answer: "حالياً، دوراتنا متاحة عبر الإنترنت فقط للحصول على أفضل تجربة تعليمية. ومع ذلك، يمكنك تحميلالتصنيفالتعليمية والملفات PDF والموارد للاستخدام بدون إنترنت. نحن نعمل على تحميل الفيديوهات بدون إنترنت للأعضاء المميزين."
  },
  {
    id: 6,
    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden">
      ...
      >
        ...
        <div className="flex-shrink-0">
          {isOpen ? (
            <FaChevronUp className="w-5 h-5 text-primary dark:text-primary-light transition-transform duration-200" />
          ) : (
      ...
      <div className={`overflow-hidden transition-all duration-300 ease-in-out ${isOpen ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'
        ...
        <div className="px-6 pb-4">
          <div className="border-t border-gray-200 dark:border-gray-700 pt-4">
            ...
            {isOpen && (
              <div className="mt-4 flex items-center gap-2 text-sm text-primary dark:text-primary-light">
      ...
      {displayedItems.length > 0 ? (
          ...
          {filteredItems.length > 4 && (
            <div className="text-center pt-4">
              <button
                ...
                className="inline-flex items-center gap-2 text-primary dark:text-primary-light hover:text-primary-dark dark:hover:text-primary-darker font-medium transition-colors duration-200"
              >
                {showAll ? (
                  <>
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="text-center py-8">
          ...
          <button
            ...
            className="mt-4 inline-flex items-center gap-2 text-primary dark:text-primary-light hover:text-primary-dark dark:hover:text-primary-darker font-medium"
          >
            مسح البحث
          </button>
        </div>
