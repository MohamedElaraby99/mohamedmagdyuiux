  ...
  const renderMeetingCard = (meeting) => (
    <div key={meeting._id} className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-shadow duration-300">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
        ...
        <div className="flex items-center text-gray-600 dark:text-gray-300">
          <FaChalkboardTeacher className="ml-2 text-green-500" />
          <span className="text-sm">{meeting.instructor?.name}</span>
        </div>
        <div className="flex items-center text-gray-600 dark:text-gray-300">
          <FaBookOpen className="ml-2 text-green-500" />
        ...
        <div className="flex gap-2">
          ...
          {isMeetingUpcoming(meeting) && (
            <button
              ...
              className="flex items-center gap-1 px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg transition-colors duration-200 text-sm"
            >
              <FaPlay />
              تذكير
            </button>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center">
                      <FaChalkboardTeacher className="ml-3 text-green-500" />
