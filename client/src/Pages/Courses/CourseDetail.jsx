              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
                ...
                <div className="lg:col-span-1">
                  <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 sm:p-6 lg:sticky lg:top-6">
                    ...
                    {user && isLoggedIn && user.role !== 'ADMIN' && user.role !== 'SUPER_ADMIN' && !isCoursePurchased() && (
                        ...
                        <form onSubmit={handleRedeemCode} className="space-y-4">
                          ...
                          <div className="hidden sm:flex flex-col sm:flex-row gap-3">
                            <input
                              ...
                              className="flex-1 min-w-0 px-4 py-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary focus:border-transparent transition-all duration-200 text-center font-mono text-lg tracking-wider"
                              maxLength="12"
                            ...
                            <button
                              type="submit"
                              className={`px-4 sm:px-6 py-3 text-white rounded-lg font-medium transition-all duration-200 flex-shrink-0 min-w-max ${courseAccessState?.source === 'code' && !courseAccessState?.hasAccess
                          ...
                          <div className="sm:hidden space-y-3">
                            <input
                              ...
                              placeholder="زي كده: ABC123XYZ9"
                              className="w-full px-4 py-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary focus:border-transparent transition-all duration-200 text-center font-mono text-lg tracking-wider"
                              maxLength="12"
                              style={{ letterSpacing: '0.1em' }}
                              required
                            />
                            <button
                              type="submit"
                              className={`w-full px-4 py-3 text-white rounded-lg font-medium transition-all duration-200 ${courseAccessState?.source === 'code' && !courseAccessState?.hasAccess
                                ? 'bg-red-600 hover:bg-red-700 focus:ring-red-500'
                                : 'btn-primary focus:ring-primary'
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="bg-primary/10 dark:bg-primary/20 border border-primary/30 dark:border-primary/50 rounded-lg p-3">
                              <h4 className="text-xs font-medium text-primary-dark dark:text-primary-light mb-1">حاجات مهمة:</h4>
                              <ul className="text-xs text-primary-dark/80 dark:text-primary-light/80 space-y-1">
