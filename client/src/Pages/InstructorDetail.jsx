    ...
    <Layout>
      <div className="min-h-screen bg-gradient-to-br from-green-50 via-indigo-50 to-green-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900" dir="rtl">
        <div className="container mx-auto px-4 py-8">
          ...
          <button
            onClick={() => navigate('/instructors')}
            className="flex items-center gap-2 text-green-600 hover:text-green-700 dark:text-green-400 dark:hover:text-green-300 mb-8 transition-colors"
          >
            <FaArrowLeft />
            العودة لقائمة المدرسين
          </button>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden mb-8">
            <div className="relative">
              {/* Background Image */}
              <div className="w-full h-48 bg-gradient-to-r from-green-500 to-green-600"></div>
              ...
              {/* Featured Badge */}
              {instructor.featured && (
                <div className="absolute top-4 left-4 bg-green-400 text-green-900 px-4 py-2 rounded-full text-sm font-semibold">
                  مميز
                </div>
              )}
            </div>
            ...
            <div className="pt-20 pb-6 px-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="text-center p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
                  <FaUsers className="w-8 h-8 text-green-600 dark:text-green-400 mx-auto mb-2" />
                ...
                <div className="text-center p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
                  <FaGraduationCap className="w-8 h-8 text-green-600 dark:text-green-400 mx-auto mb-2" />
                  <div className="text-2xl font-bold text-gray-800 dark:text-white">
                    ...
                    <div className="space-y-3">
                      ...
                      {instructor.socialLinks?.twitter && instructor.socialLinks.twitter.trim() !== '' && (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="flex items-center gap-2 text-green-400 hover:text-green-500 dark:text-green-300 dark:hover:text-green-200 transition-colors"
                        >
                          <FaTwitter />
                          Twitter
                        </a>
