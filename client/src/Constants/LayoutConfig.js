...
// ============================================
export const HERO = {
    // نص صغير فوق العنوان (إنجليزي — يُعرض LTR)
    eyebrowText: "2026 MASTERCLASS",
    // العنوان الرئيسي
...
export const FOOTER = {
    ...
    companyName: "MAGDY ACADEMY",
    // وصف قصير تحت الاسم
    tagline:
        "الوجهة الأولى للتعليم الراقي في تصميم واجهات المستخدم وتجربة الاستخدام.",
    // نص حقوق النشر
