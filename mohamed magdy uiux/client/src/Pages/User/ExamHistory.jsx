      ...
      <Layout>
        <div className="min-h-screen bg-gradient-to-br from-green-50 via-indigo-50 to-green-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400">يجب عليك تسجيل الدخول لعرض سجل الامتحانات.</p>
          </div>
        </div>
      </Layout>
    );
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              عرض جميع نتائج الامتحانات والأداء الخاص بك
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 mb-6 sm:mb-8">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg p-4 sm:p-6 shadow-lg">
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <div>
                  <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">الامتحانات النهائية</p>
                  <p className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden">
            ...
            {loading ? (
              ...
              <div className="p-8 text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">خطأ في تحميل النتائج</h3>
                <p className="text-gray-600 dark:text-gray-400">{error}</p>
              </div>
            ) : examHistory.length === 0 ? (
              <div className="p-8 text-center">
                <FaHistory className="text-6xl text-gray-400 mx-auto mb-4" />
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">لا توجد نتائج امتحانات</h3>
                <p className="text-gray-600 dark:text-gray-400">
                  لم تقم بأداء أي امتحانات بعد. ابدأ التعلم وقم بأداء بعض الامتحانات!
                </p>
              </div>
            ) : (
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                        ...
                        <div className="flex items-center gap-1 sm:gap-2">
                          ...
                          <div className="min-w-0">
                            ...
                            <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 truncate">
                              {result.examType === 'training' ? 'امتحان تدريبي' : 'امتحان نهائي'}
                      ...
                      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-4">
                        ...
                        <div className="flex items-center gap-1 sm:gap-2 text-xs sm:text-sm text-gray-600 dark:text-gray-400">
                          ...
                          <span>{result.timeTaken} دقيقة</span>
                        </div>
              ...
              <div className="p-6 border-t border-gray-200 dark:border-gray-700">
                <div className="flex items-center justify-between">
                  <div className="text-sm text-gray-600 dark:text-gray-400">
                    عرض {((examHistoryPagination.currentPage - 1) * examHistoryPagination.resultsPerPage) + 1} إلى{' '}
                    {Math.min(examHistoryPagination.currentPage * examHistoryPagination.resultsPerPage, examHistoryPagination.totalResults)} من{' '}
                    {examHistoryPagination.totalResults} نتيجة
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-gray-600 dark:text-gray-400">
                      صفحة {examHistoryPagination.currentPage} من {examHistoryPagination.totalPages}
                    </span>
              ...
              <div className="p-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                  <div className="text-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                    ...
                    <div className="text-sm text-gray-600 dark:text-gray-400">الدرجة</div>
                  </div>
                  ...
                  <div className="text-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                    ...
                    <div className="text-sm text-gray-600 dark:text-gray-400">الإجابات الصحيحة</div>
                  </div>
