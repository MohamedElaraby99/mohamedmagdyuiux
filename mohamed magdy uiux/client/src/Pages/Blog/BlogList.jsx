        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row gap-4 mb-8">
            ...
            <select
              ...
              className="px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 text-right"
            >
              ...
              {blogs?.map((blog) => (
                <div key={blog._id} className="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
                  ...
                  <div className="p-6">
                    ...
                    <Link
                      to={`/blog/${blog._id}`}
                      className="inline-block bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg transition-colors duration-200"
                    >
                      اقرأ المزيد
                    </Link>
                  </div>
