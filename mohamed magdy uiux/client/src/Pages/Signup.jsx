                ...
                <div className="group">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      type="tel"
                      required={false}
                      className={`block w-full pr-12 pl-4 py-4 border-2 rounded-xl bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-4 transition-all duration-300 text-right shadow-sm hover:shadow-md ${fieldErrors.fatherPhoneNumber
                        ? 'border-red-500 focus:ring-red-500/20 focus:border-red-500'
                        : 'border-gray-200 dark:border-gray-600 focus:ring-primary/20 focus:border-primary'
                        }`}
                ...
                <div className="group">
                  ...
                  <div className="relative">
                    ...
                    <select
                      ...
                      name="stage"
                      required
                      className={`block w-full pr-12 pl-4 py-4 border-2 rounded-xl bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-4 transition-all duration-300 text-right shadow-sm hover:shadow-md ${fieldErrors.stage
                        ? 'border-red-500 focus:ring-red-500/20 focus:border-red-500'
                        : 'border-gray-200 dark:border-gray-600 focus:ring-primary/20 focus:border-primary'
                        }`}
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-hidden">
            ...
            <div className="px-6 py-4 overflow-y-auto max-h-[60vh]">
              <div className="space-y-4">
                {/* Important Notice */}
                <div className="bg-primary/10 dark:bg-primary/20 border border-primary/20 dark:border-primary/50 rounded-lg p-4">
                  <div className="flex items-start gap-3">
                    <FaExclamationTriangle className="text-primary text-lg flex-shrink-0 mt-0.5" />
                    <p className="text-primary-darker dark:text-primary-light text-sm leading-relaxed text-right">
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className={`flex-1 px-4 py-2.5 rounded-lg font-medium text-sm transition-all duration-200 flex items-center justify-center gap-2 ${termsAccepted
                      ? 'btn-primary text-white shadow-sm hover:shadow-md'
