  ...
  const renderStars = (rating) => {
    ...
    for (let i = 1; i <= 5; i++) {
      stars.push(
        <FaStar
          key={i}
          className={`text-sm ${i <= rating ? 'text-green-400' : 'text-gray-300'}`}
        />
      );
    }
    return stars;
      ...
      <section className="py-20 bg-white dark:bg-gray-900" dir="rtl">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <div className="w-24 h-1 bg-gradient-to-r from-green-500 to-green-500 mx-auto mb-6"></div>
      ...
      <section className="py-20 bg-white dark:bg-gray-900" dir="rtl">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {featuredInstructors.map((instructor, index) => (
              ...
              >
                ...
                <div className="relative w-full aspect-[4/3] bg-gradient-to-br from-green-50 to-green-50 dark:from-gray-800 dark:to-gray-700 rounded-lg overflow-hidden flex items-center justify-center">
                ...
                <div className="p-6">
                  ...
                  <div className="flex justify-end">
                    <div className="w-10 h-10 bg-gradient-to-r from-green-500 to-green-500 hover:from-green-600 hover:to-green-600 text-white rounded-full flex items-center justify-center transition-colors duration-200 group-hover:scale-110">
          ...
          <div className="text-center mt-16">
            <Link
              to="/instructors"
              className="inline-flex items-center px-8 py-3 bg-gradient-to-r from-green-500 via-green-600 to-green-500 hover:from-green-600 hover:via-green-700 hover:to-green-600 text-white rounded-xl font-semibold transition-all duration-200 transform hover:scale-105"
            >
              عرض جميع المدرسين
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()} dir="rtl">
            ...
            <div className="p-6">
              ...
              <div className="text-center mb-8">
                ...
                <div className="inline-flex items-center bg-gradient-to-r from-green-100 to-green-100 dark:from-green-900/30 dark:to-green-900/30 text-green-700 dark:text-green-300 px-4 py-2 rounded-full font-semibold mb-4">
                    ...
                    <div className="flex items-center justify-center gap-4">
                      {selectedInstructor.socialLinks?.linkedin && selectedInstructor.socialLinks.linkedin.trim() !== '' && (
                        <a
                          ...
                          className="w-12 h-12 bg-gradient-to-r from-green-500 to-green-500 hover:from-green-600 hover:to-green-600 text-white rounded-full flex items-center justify-center transition-colors"
                        >
              ...
              {selectedInstructor.featured && (
                <div className="text-center mb-6">
                  <div className="inline-flex items-center bg-gradient-to-r from-green-400 to-green-500 text-white px-6 py-3 rounded-full font-bold">
