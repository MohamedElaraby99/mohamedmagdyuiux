  ...
  try {
    ...
    switch (dbType) {
      case 'atlas':
        ...
        break;
      case 'compass':
        uri = process.env.MONGO_URI_COMPASS || 'mongodb://127.0.0.1:27017/mohamedmagdyuiuxtabase';
        break;
      case 'community':
    ...
    const sampleInstructors = [
      {
        ...
        bio: "مدرس متميز في  مع خبرة 10 سنوات في تدريس المناهج المصرية",
        specialization: "",
        experience: 10,
        education: "ماجستير في  التطبيقية",
        socialLinks: {
